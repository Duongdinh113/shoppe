    ...
    <div class="font-dmSans mx-auto mt-10 max-w-[1500px] ">
        ...
        <div>
            <div class="mt-[96px] text-center">
                ...
                <p class="mt-[16px] font-weight text-base text-[#000000]">
            ...
            <div class="mt-[48px] flex justify-center items-center">
                <div class=" text-start inline-block w-[670px]">
                    ...
                    <a href=""><img class="mt-[23px] w-full" src="../images/Img 04.png" alt=""></a>
                   
                        <div class="text-start inline-block w-[670px] mt-[48px]">
                            <p class="text-base font-weight ">
                                Duis rutrum dictum libero quis rutrum. Etiam sed neque aliquam, sollicitudin ante a, gravida arcu. Nam fringilla molestie velit, eget pellentesque risus scelerisque a. Nam ac urna maximus, tempor magna et, placerat urna. Curabitur eu magna enim. Proin placerat tortor lacus, ac sodales lectus placerat quis. 
                            </p>
                            <ul class="mt-4">
            ...
            <div class="mt-[48px] ml-[400px] flex justify-center items-center w-[670px]">
                <div class="inline-block w-[670px]">
                    <p class="font-weight text-2xl">Produced with care</p>
                    <a href=""><img class="mt-[23px] w-full" src="../images/Img 01.png" alt=""></a>
                    <p class="text-base font-weight mt-[48px]">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam placerat, augue a volutpat
                        hendrerit, sapien tortor faucibus augue, a maximus elit ex vitae libero.
                    </p>
