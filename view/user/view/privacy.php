...
<body>
    ...
    <div class="font-dmSans mx-auto mt-10 max-w-[1500px] ">
        ...
        <div class="mt-[96px] text-center ">
            <div class="inline-block w-[700px] text-start">
                <p class="text-3xl font-medium text-[#000000] text-center">Privacy Policy</p>
                <p class="mt-10 text-base text-[#000000]">Duis rutrum dictum libero quis rutrum. Etiam sed neque
                    aliquam, sollicitudin ante a, gravida arcu. Nam fringilla molestie velit, eget pellentesque risus
                    scelerisque a. Nam ac urna maximus, tempor magna et, placerat urna. Curabitur eu magna enim. Proin
                    placerat tortor lacus, ac sodales lectus placerat quis. </p>
                <p class="mt-10 text-2xl text-[#000000]">Security</p>
                <p class="mt-6 text-base">Duis rutrum dictum libero quis rutrum. Etiam sed neque aliquam, sollicitudin
                    ante a, gravida arcu. Nam fringilla molestie velit, eget pellentesque risus scelerisque.</p>
                <p class="mt-10 text-2xl text-[#000000]">Cookies</p>
                <ul class="ml-8 mt-6">
                    <li>
