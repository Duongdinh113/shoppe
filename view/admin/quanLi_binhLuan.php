...
<body class="max-w-full m-auto">
    ...
    <div>
            ...
            <div class="flex ">
                <div class="flex">
                    ...
                    <div class="text-[#37A9CD]">
                        ...
                        <button class="p-2 border-[1px] bg-[#38A169] shadow-slate-400	 hover:text-[white]">
        ...
        <div class="flex gap-5 justify-between my-[50px]">
            ...
            <div>
                ...
                <div>
                    <div class="max-w-[1000px] mr-[140px]">
                        <p class="absolute text-[white] font-bold right-[600px] top-[180px]">Quản lý bình luận</p>
                            ...
                            <form action="./quanLi_user.php" method="POST">
                                <div class="flex gap-2">
                                    <div>
                                        ...
                                        <input class="border-[1px] border-[black] rounded pl-[30px] h-[30px]"
                                            placeholder="Tìm kiếm" type="text" name="search">
                                    </div>
                                    <div>
                                        <button
                                            class="p-1 border-[1px] border-[#38A169] h-[30px] rounded text-[white] font-bold bg-[#38A169]">Search</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($productList as $product): ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="../../control/control_deleteUser.php?id=<?php echo $product["id"] ?>"><button
                                                    class="border-[1px] rounded w-[100px] bg-[#1E74A4] text-[white] ">xóa
                                                    bình luận</button></a>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
