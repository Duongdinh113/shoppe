...
<body>
    ...
    <div class="menu">
        ...
        <!-- <div class="welcome" style="margin-top: 20px; margin-bottom: 55px;">
            ...
            <form action="../../controlers/controler_update-product.php" method="POST" enctype="multipart/form-data">
                ...
                <input type="number" name="deal" value="<?php echo $hanghoa["deal"]?>" placeholder="Nhập giá giảm giá" required><br>
