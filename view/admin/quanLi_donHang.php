                ...
                <div>
                    <div>
                        <div class="max-w-[1000px] mr-[140px]">
                            <p class="absolute text-[white] font-bold right-[600px] top-[180px]">Quản lý đơn hàng</p>
                            ...
                            <div class="my-[15px]">
                                <form action="./quanLi_user.php" method="POST">
                                    <div class="flex gap-2">
                                        <div>
                                            <img class="absolute pt-1 p-1" src="../../viewND/image/Search.png" alt="">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-danger"
                                                    href="./bill_detail.php?id=<?php echo $product["id"] ?>">Chi tiết</a>
