    ...
    <div class="container">
        <div class="menu">
            ...
            <ul>
                ...
                <li><img src="../../image/Vector (2).png" alt=""><a href="./product.php">Quản lý Sản Phẩm </a></li>
                <li><img src="../../image/Vector (2).png" alt=""><a href="./type.php">Quản lý loại hàng</a></li>
                        ...
                        <?php foreach ($list as $list) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="../../controlers/controler_delete-product.php?id=<?php echo $list['id_p'] ?>" onclick="return confirm('Bạn có chắc muốn xóa')"><button class="red">Xóa</button></a>
                                </td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
