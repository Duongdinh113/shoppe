        ...
        <div class="flex gap-5 justify-between my-[30px]">
            ...
            <div>
                <div class="max-w-[1000px] mr-[140px]">
                    <p class="absolute text-[white] font-bold right-[600px] top-[180px]">Quản lý danh mục</p>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($productList as $product): ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="../../control/control_xoa-loai.php?id=<?php echo $product["iddm"] ?>"><button
                            ...
                            <a href="./them_loai.php"><button
                                    class="mb-3 w-[200px] h-[30px] rounded-[10px] bg-[#38A169] text-[white] font-bold">Add
                                    new</button></a>
